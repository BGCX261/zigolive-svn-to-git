...
FOR %%x IN ("C:\tim_jboss\seam_workbench\BarBottin\lib/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\tim_jboss\seam_workbench\BarBottin\lib/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\tim_jboss\seam_workbench\BarBottin\lib/pear_bin"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\tim_jboss\seam_workbench\BarBottin\lib\"
GOTO :INSTALLED
